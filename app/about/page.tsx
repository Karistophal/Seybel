...
export const metadata: Metadata = {
  title: 'À propos — Lyne Seybel',
  description: 'Biographie et parcours artistique de Lyne Seybel, peintre française contemporaine, originaire de Bourges, ayant vécu à Paris, en Normandie, à Venise et en Auvergne.',
};
